...
public class RingPlot_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Graphics2D", false, RingPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.geom.Rectangle2D", false, RingPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.axis.AxisLocation", false, RingPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.MarkerChangeEvent", false, RingPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PlotOrientation", false, RingPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PlotRenderingInfo", false, RingPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.DatasetChangeEvent", false, RingPlot_ESTest_scaffolding.class.getClassLoader()));
  }
