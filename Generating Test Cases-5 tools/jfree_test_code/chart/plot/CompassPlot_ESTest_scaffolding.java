...
public class CompassPlot_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Graphics2D", false, CompassPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.geom.Point2D", false, CompassPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.geom.Rectangle2D", false, CompassPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.needle.MeterNeedle", false, CompassPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PlotRenderingInfo", false, CompassPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PlotState", false, CompassPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.ValueDataset", false, CompassPlot_ESTest_scaffolding.class.getClassLoader()));
  }
