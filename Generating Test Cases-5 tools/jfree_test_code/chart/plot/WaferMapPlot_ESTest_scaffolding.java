...
public class WaferMapPlot_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Graphics2D", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.geom.Point2D", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.geom.Rectangle2D", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.AnnotationChangeEvent", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.PlotChangeEvent", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.RendererChangeEvent", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PlotOrientation", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PlotRenderingInfo", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PlotState", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.renderer.WaferMapRenderer", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.DatasetChangeEvent", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.WaferMapDataset", false, WaferMapPlot_ESTest_scaffolding.class.getClassLoader()));
  }
