...
public class LabelBlock_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Font", false, LabelBlock_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.FontMetrics", false, LabelBlock_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.Graphics2D", false, LabelBlock_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.block.LengthConstraintType", false, LabelBlock_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.block.RectangleConstraint", false, LabelBlock_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.Range", false, LabelBlock_ESTest_scaffolding.class.getClassLoader()));
  }
