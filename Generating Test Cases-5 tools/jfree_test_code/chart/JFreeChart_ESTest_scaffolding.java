...
public class JFreeChart_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Graphics2D", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.Shape", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.geom.Point2D", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.geom.Rectangle2D", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.ChartRenderingInfo", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.ChartChangeEvent", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.ChartChangeListener", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.ChartProgressEvent", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.ChartProgressListener", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.PlotChangeEvent", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.TitleChangeEvent", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.Plot", false, JFreeChart_ESTest_scaffolding.class.getClassLoader()));
  }
