...
public class LegendGraphic_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Graphics2D", false, LegendGraphic_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.Paint", false, LegendGraphic_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.Shape", false, LegendGraphic_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.block.LengthConstraintType", false, LegendGraphic_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.block.RectangleConstraint", false, LegendGraphic_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.Range", false, LegendGraphic_ESTest_scaffolding.class.getClassLoader()));
  }
