...
public class StandardChartTheme_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.jfree.chart.JFreeChart", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.annotations.XYAnnotation", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.axis.CategoryAxis", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.axis.PeriodAxis", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.axis.SymbolAxis", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.axis.ValueAxis", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.block.Block", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.block.BlockContainer", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.CategoryPlot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.FastScatterPlot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.MeterPlot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.MultiplePiePlot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PiePlot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.Plot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PolarPlot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.SpiderWebPlot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.ThermometerPlot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.XYPlot", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.renderer.AbstractRenderer", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.renderer.category.CategoryItemRenderer", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.renderer.xy.XYItemRenderer", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.title.Title", false, StandardChartTheme_ESTest_scaffolding.class.getClassLoader()));
  }
