...
public class PieSectionEntity_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.Shape", false, PieSectionEntity_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.geom.PathIterator", false, PieSectionEntity_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.lang.Comparable", false, PieSectionEntity_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.imagemap.ToolTipTagFragmentGenerator", false, PieSectionEntity_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.imagemap.URLTagFragmentGenerator", false, PieSectionEntity_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.PieDataset", false, PieSectionEntity_ESTest_scaffolding.class.getClassLoader()));
  }
