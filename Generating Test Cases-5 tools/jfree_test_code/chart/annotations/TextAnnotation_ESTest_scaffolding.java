...
public class TextAnnotation_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.EventListener", false, TextAnnotation_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.event.AnnotationChangeListener", false, TextAnnotation_ESTest_scaffolding.class.getClassLoader()));
  }
