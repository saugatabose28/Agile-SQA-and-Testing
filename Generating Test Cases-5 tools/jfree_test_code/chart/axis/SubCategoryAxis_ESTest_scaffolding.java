...
public class SubCategoryAxis_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.FontMetrics", false, SubCategoryAxis_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.Graphics2D", false, SubCategoryAxis_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.axis.AxisSpace", false, SubCategoryAxis_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.plot.PlotRenderingInfo", false, SubCategoryAxis_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.chart.ui.RectangleEdge", false, SubCategoryAxis_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.category.CategoryDataset", false, SubCategoryAxis_ESTest_scaffolding.class.getClassLoader()));
  }
