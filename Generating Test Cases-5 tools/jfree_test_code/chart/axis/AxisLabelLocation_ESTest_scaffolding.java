...
public class AxisLabelLocation_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.jfree.chart.axis.AxisLabelLocation"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AxisLabelLocation_ESTest_scaffolding.class.getClassLoader() ,
      "org.jfree.chart.axis.AxisLabelLocation"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AxisLabelLocation_ESTest_scaffolding.class.getClassLoader()); 
