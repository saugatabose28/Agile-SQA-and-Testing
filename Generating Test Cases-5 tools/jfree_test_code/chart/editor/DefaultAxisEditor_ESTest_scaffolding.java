...
public class DefaultAxisEditor_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.awt.event.ActionEvent", false, DefaultAxisEditor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.ComponentListener", false, DefaultAxisEditor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.KeyListener", false, DefaultAxisEditor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.MouseEvent", false, DefaultAxisEditor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.MouseListener", false, DefaultAxisEditor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.awt.event.MouseWheelListener", false, DefaultAxisEditor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.beans.VetoableChangeListener", false, DefaultAxisEditor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.PrintStream", false, DefaultAxisEditor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.swing.event.AncestorListener", false, DefaultAxisEditor_ESTest_scaffolding.class.getClassLoader()));
