...
public class DefaultBoxAndWhiskerCategoryDataset_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.Comparable", false, DefaultBoxAndWhiskerCategoryDataset_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.EventListener", false, DefaultBoxAndWhiskerCategoryDataset_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.DatasetChangeListener", false, DefaultBoxAndWhiskerCategoryDataset_ESTest_scaffolding.class.getClassLoader()));
  }
