...
public class TimeSeries_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Calendar", false, TimeSeries_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.TimeZone", false, TimeSeries_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.general.SeriesChangeListener", false, TimeSeries_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.time.RegularTimePeriod", false, TimeSeries_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfree.data.time.TimePeriodAnchor", false, TimeSeries_ESTest_scaffolding.class.getClassLoader()));
  }
