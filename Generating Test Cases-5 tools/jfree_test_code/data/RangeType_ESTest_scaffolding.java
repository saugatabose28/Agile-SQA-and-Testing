...
public class RangeType_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.jfree.data.RangeType"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RangeType_ESTest_scaffolding.class.getClassLoader() ,
      "org.jfree.data.RangeType"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RangeType_ESTest_scaffolding.class.getClassLoader()); 
